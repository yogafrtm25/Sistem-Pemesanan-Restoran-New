      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="form-group mb-2">
            ...
            <input onchange="pilih_tanggal(this.value)" type="date" class="form-control" name="tanggal_pemesanan"
              id="tanggal_pemesanan" min="<?= date("Y-m-d"); ?>" max="<?= date('Y-m-d', strtotime('+21 day')) ?>">
          </div>
          <div class="form-group mb-2">
          ...
          <div class="form-group mb-2">
            ...
            <small class="form-text" style="color: red;">*Wajib Diisi</small>
            <input type="number" min="1" class="form-control" id="jumlah_pesanan" name="jumlah_pesanan"
              placeholder="Jumlah Pesanan">
            </select>
          </div>
          <br>
          <div class="text-center"><button class="btn btn-success" onclick="tambah_menu()" type="submit">Tambah
              Menu</button></div>
        </div>
        <div class="col-lg-6">
