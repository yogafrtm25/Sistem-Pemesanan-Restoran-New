          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="h2 font-weight-bold mb-0">Rp. <?= $total_pendapatan_bulan_ini->total_pendapatan_bulan_ini?></span>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="h2 font-weight-bold mb-0">Rp. <?= $total_pendapatan->total_pendapatan  ?></span>
              </div>
              <div class="col-auto">
